<?php
/**
 * Class Name: azirspares_bootstrap_navwalker
 ...
 */
if ( ! class_exists( 'Azirspares_navwalker' ) ) {
	class Azirspares_navwalker extends Walker_Nav_Menu {
		/**
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
				...
				$attributes = ' class="azirspares-menu-item-title"';
