...
$store_open_notice = isset($store_info['dokan_store_open_notice']) && !empty($store_info['dokan_store_open_notice']) ? $store_info['dokan_store_open_notice'] : __('Store Open', 'azirspares');
$store_closed_notice = isset($store_info['dokan_store_close_notice']) && !empty($store_info['dokan_store_close_notice']) ? $store_info['dokan_store_close_notice'] : __('Store Closed', 'azirspares');
                ...
                <div class="profile-info">
                    ...
                    <ul class="dokan-store-info">
                        <?php if (isset($store_address) && !empty($store_address)) { ?>
                            <li class="dokan-store-address"><i class="fa fa-map-marker"></i>
                                <?php echo wp_specialchars_decode($store_address) ?>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($store_user->show_email() == 'yes') { ?>
                            <li class="dokan-store-email">
                                ...
                                <a href="mailto:<?php echo esc_url($store_user->get_email()); ?>"><?php echo esc_url($store_user->get_email()); ?></a>
                            </li>
                        <?php } ?>
                    ...
                    <?php if ($social_fields) { ?>
                        <div class="store-social-wrapper">
                            <span><?php echo esc_html__('follow us :','azirspares')?></span>
