...
add_action( 'woocommerce_before_shop_loop_item_title', 'azirspares_gallery_product_thumbnail', 10, 1 );
add_action( 'woocommerce_shop_loop_item_title', 'woocommerce_show_product_loop_sale_flash', 1 );
?>
    <div class="product-inner equal-container better-height" data-items="2">
        <div class="product-thumb equal-elem">
