<div class="tool-box bg-white p-20p ">
    ...
    <p class="submit">
        <?php
        $merge_url = admin_url('admin.php?import=wt_woocommerce_product_csv&merge=1');
        $merge_n_skip_url = admin_url('admin.php?import=wt_woocommerce_product_csv&merge=1&skip_new=1');
        $skip_url = admin_url('admin.php?import=wt_woocommerce_product_csv&skip_new=1');
        $import_url = admin_url('admin.php?import=wt_woocommerce_product_csv');
        ?>
        <a class="button button-primary" id="mylink" href="<?php echo admin_url('admin.php?import=wt_woocommerce_product_csv'); ?>"><?php _e('Go to Import', 'wf_csv_import_export'); ?></a>
        &nbsp;
