<?php
    ...
    // Get current image.
    $attachment_id = get_post_meta($post->ID, 'azirspares_mapper_image', true);
    ...
    $settings = get_post_meta($post->ID, 'azirspares_mapper_settings', true);

    // Get all pins.
    $pins = get_post_meta($post->ID, 'azirspares_mapper_pins', true);
?>
<script type="text/html" id="azirspares_mapper_tmpl">
    <div class="azirspares-mapper-wrap">
        <div class="azirspares-mapper-top">
            <div class="title">
                <input type="text" name="post_title" class="input-text" placeholder="<?php
                    _e('Enter Title Here', 'azirspares-toolkit');
                ?>" value="<?php
                    esc_attr_e($post->post_title);
                ?>">
            </div>
        </div><!-- .azirspares-mapper-top -->
        <div class="azirspares-mapper bdgr bgw">
            <div class="azirspares-mapper-mid fc aic jcsb pd__20 bggr">
                <div class="global-setting fc aic">
                    <div id="general-settings">
                        <a href="javascript:void(0)" class="btn br__3 dib">
                            <i class="wricon-cog mr__5"></i>
                            <?php _e('General Settings', 'azirspares-toolkit'); ?>
                        </a>
                        ...
                        <div class="setting-box general-setting br__3 bgw bdgr">
                            ...
                            <ul class="nav mg__0 fc">
                                <li data-nav="style"
                                    class="mg__0 active"><?php _e('Style Settings', 'azirspares-toolkit'); ?></li>
                                <!-- <li data-nav="image-effect" class="mg__0"><?php _e('Image Effect', 'azirspares-toolkit'); ?></li> -->
                            </ul>

                            <div class="tab-content">
                                <div data-tab="style" class="tab-item">
                                    <label class="db mb__10"><?php _e('Popup size', 'azirspares-toolkit'); ?></label>
                                    <div class="row mb__25">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Width', 'azirspares-toolkit'); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Height', 'azirspares-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Tooltip style', 'azirspares-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="tooltip-style" class="slt select-large">
                                                    <option value="light"><?php _e('Light', 'azirspares-toolkit'); ?></option>
                                                    <option value="dark"><?php _e('Dark', 'azirspares-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup box shadow', 'azirspares-toolkit'); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup show fffect', 'azirspares-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="popup-show-effect" class="slt select-large">
                                                    <option value=""><?php _e('None', 'azirspares-toolkit'); ?></option>
                                                    <option value="fade"><?php _e('Fade In', 'azirspares-toolkit'); ?></option>
                                                    <option value="slide-left"><?php _e('Slide From Left', 'azirspares-toolkit'); ?></option>
                                                    <option value="slide-right"><?php _e('Slide From Right', 'azirspares-toolkit'); ?></option>
                                                    <option value="slide-top"><?php _e('Slide From Top', 'azirspares-toolkit'); ?></option>
                                                    <option value="slide-bottom"><?php _e('Slide From Bottom', 'azirspares-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border radius', 'azirspares-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border width', 'azirspares-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border color', 'azirspares-toolkit'); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Image effect', 'azirspares-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="image-effect" class="slt select-large">
                                                    <option value="none"><?php _e('None', 'azirspares-toolkit'); ?></option>
                                                    <option value="blur"><?php _e('Blur', 'azirspares-toolkit'); ?></option>
                                                    <option value="gray"><?php _e('Gray', 'azirspares-toolkit'); ?></option>
                                                    <option value="mask"><?php _e('Mask Overlay', 'azirspares-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4" data-image-effect="mask">
                                            <label class="db mb__10"><?php _e('Mask color', 'azirspares-toolkit'); ?></label>
                                            <div class="picker-styled pr">
                    ...
                    <div class="azirspares-copy-shortcode">
                        <span class="shortcode-name"><?php echo esc_html__('Copy Shortcode','azirspares')?></span>
                        <input id="shortcode-syntax" class="shortcode-syntax" value='[azirspares_mapper id="<?php echo absint($post->ID); ?>"]'>
                    </div>
                </div>
            </div><!-- .azirspares-mapper-mid -->

            <div class="azirspares-mapper-bot pr aic fc jcc <?php if ($attachment_id) echo 'pr'; ?>">
                <input type="hidden" id="azirspares_mapper_image" name="azirspares_mapper_image"
                       value="<?php echo absint($attachment_id); ?>">

                <?php if ($attachment_id) : ?>
                    <div class="edit-image pr">
                        <a id="change-image" href="#" class="btn-change-image pa db br__3">
                            <i class="wricon-camera mr__5"></i><?php _e('Change Image', 'azirspares-toolkit'); ?>
                        </a>
                ...
                <?php else : ?>
                    <div class="add-image">
                        ...
                        <span class="empty-mapper"><?php _e('Add your image mapping', 'azirspares-toolkit'); ?></span>
                    </div>
                <?php endif; ?>
            </div><!-- .azirspares-mapper-bot -->
        </div><!-- .azirspares-mapper -->
    </div>
</script>

<script type="text/html" id="azirspares_mapper_image_tmpl">
    <div class="edit-image pr">
        <a id="change-image" href="#" class="btn-change-image pa db br__3">
            <i class="fa fa-camera-retro mr__5" aria-hidden="true"></i><?php _e('Change Image', 'azirspares-toolkit'); ?>
        </a>
...
<script type="text/html" id="azirspares_mapper_pin_tmpl">
    ...
    <div class="setting-box pin-setting br__3 bgw bdgr">
        <h4 class="mg__0 pr">
            <?php _e('Pin Settings', 'azirspares-toolkit'); ?>
            <i class="close-box pa">x</i>
        </h4>
        ...
        <ul class="nav mg__0 fc">
            <li data-nav="general" class="mg__0 active"><?php _e('General', 'azirspares-toolkit'); ?></li>
            <li data-nav="icon-settings" class="mg__0"><?php _e('Icon Settings', 'azirspares-toolkit'); ?></li>
            <li data-nav="popup-settings" class="mg__0"><?php _e('Popup Settings', 'azirspares-toolkit'); ?></li>
        </ul>
        ...
        <div class="tab-content">
            <div data-tab="general" class="tab-item">
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('WooCommerce', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('Image', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('Text', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('Link', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-input mb__25" data-pin-type="woocommerce">
                    <label class="db mb__10"><?php _e('Select product', 'azirspares-toolkit'); ?></label>
                    ...
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show thumbnail', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show description', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show rate', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-input mb__25" data-pin-type="image|text|link">
                    <label class="db mb__10"><?php _e('Popup title', 'azirspares-toolkit'); ?></label>
                    <input type="text" data-option="settings[popup-title]" class="input-text input-large" value=""
                           placeholder="<?php
                               _e('Input a title for the popup here...', 'azirspares-toolkit');
                           ?>">
                </div>

                <!-- Image Settings -->
                <div class="input-group mb__25" data-pin-type="image">
                    <label class="db mb__10"><?php _e('Select image', 'azirspares-toolkit'); ?></label>
                    <div class="pr">
                ...
                <div class="row mb__25" data-pin-type="image|link">
                    <div class="cm-7">
                        <div class="form-input">
                            <label class="db mb__10"><?php _e('Link To', 'azirspares-toolkit'); ?></label>
                            <input type="text" data-option="settings[image-link-to]" class="input-text input-large"
                                   value="">
                        </div>
                    </div>
                    <div class="cm-5">
                        <label class="db mb__10"><?php _e('Target', 'azirspares-toolkit'); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[image-link-target]" class="slt select-large">
                                <option value="_self"><?php _e('Default', 'azirspares-toolkit'); ?></option>
                                <option value="_blank"><?php _e('New Tab', 'azirspares-toolkit'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-input" data-pin-type="text">
                    <label class="db mb__10"><?php _e('Text Content', 'azirspares-toolkit'); ?></label>
                    <textarea data-option="settings[text]" rows="6" placeholder="<?php
                        _e('Input some content for the popup here...', 'azirspares-toolkit');
                    ?>"></textarea>
                </div>
                <!-- End Text Settings -->
            </div>
                ...
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('Area Text', 'azirspares-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div data-icon-type="icon-area">
                    <div class="row mb__20">
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text', 'azirspares-toolkit' ); ?></label>
                            <input type="text" data-option="settings[area-text]" class="text-custom input-text input-large" value="">
                        </div>
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Font Size', 'azirspares-toolkit' ); ?></label>
                        ...
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text Color', 'azirspares-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                    ...
                    <div class="row mb--20">
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Width', 'azirspares-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-width]" class="input-text input-large" value="32">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Height', 'azirspares-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-height]" class="input-text input-large" value="32">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Width', 'azirspares-toolkit' ); ?></label>
                            <div class="input input--number pr">
                                <input type="number" data-option="settings[area-border-width]" class="input-text input-large" value="0">
                            </div>
                        </div>
                        <div class="cm-3 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Radius', 'azirspares-toolkit' ); ?></label>
                            <div class="input input--number pr">
                    ...
                    <div class="row">
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Background', 'azirspares-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                        ...
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Color', 'azirspares-toolkit' ); ?></label>
                            <div class="picker-styled pr">
            ...
            <div data-tab="popup-settings" class="tab-item hidden">
                <label class="db mb__10"><?php _e('Custom popup size', 'azirspares-toolkit'); ?></label>
                <div class="row">
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e('Width', 'azirspares-toolkit'); ?></label>
                        <div class="input-unit pr">
                    ...
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e('Position', 'azirspares-toolkit'); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[popup-position]" class="slt select-large">
                                <option value="right"><?php _e('Right', 'azirspares-toolkit'); ?></option>
                                <option value="left"><?php _e('Left', 'azirspares-toolkit'); ?></option>
                                <option value="top"><?php _e('Top', 'azirspares-toolkit'); ?></option>
                                <option value="bottom"><?php _e('Bottom', 'azirspares-toolkit'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
...
?>
<script type="text/html" id="azirspares_mapper_icon_selector_tmpl">
    <div class="icon-selector select-styled pr bdgr br__3">
        ...
        <div class="icon-wrap pa bdgr">
            <h5><?php _e('Select icon', 'azirspares-toolkit'); ?><i class="close fa fa-close"></i></h5>
            <div class="azirspares-icon-list bgw bdgr fc fcw">
...
<script type="text/javascript">
    jQuery(function ($) {
        $(window).load(function () {
            // Override default UI.
            var form = $($('#azirspares_mapper_tmpl').text()).prepend($('#post').children('input[type="hidden"]'));
            ...
            setTimeout(function () {
                $(document).trigger('init_azirspares_mapper');
            }, 500);

            // Pass data to client-side.
            window.azirspares_mapper_settings = <?php echo json_encode($settings ? $settings : new stdClass()); ?>;
            window.azirspares_mapper_pins = <?php echo json_encode($pins ? array_values($pins) : array()); ?>;
        });
    });
</script>
