            ...
            _this.find('option').each(function () {
                ...
                if ( _value !== '' ) {
                    if ( _data_type == 'color') {
                        ...
                        // _this.parent().find('.data-val').append('<a class="change-value ' + _itemclass + '" href="#" style="background: ' + _data + ';background-size: cover; background-repeat: no-repeat " data-value="' + _value + '"><img src="'+ _ID +'"></a>');
