<?php
/**
 * Widget API: Azirspares_Custom_Menu_Widget class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see WP_Widget
 */
class Azirspares_Custom_Menu_Widget extends WP_Widget
{
	/**
	...
	public function __construct()
	{
		...
		parent::__construct( 'azirspares_nav_menu', __( 'Azirspares: Custom Menu' ), $widget_ops );
	}
 ...
 * @since 2.3.0
 */
function Azirspares_Custom_Menu_Widget()
{
	register_widget( 'Azirspares_Custom_Menu_Widget' );
}

add_action( 'widgets_init', 'Azirspares_Custom_Menu_Widget' );