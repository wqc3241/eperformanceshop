										...
										<tbody>
											<tr valign="top">
												...
												<td class="forminp forminp-text">
													...
													?>
													<span class="description"><?php echo esc_html__( 'Override filter title.', 'prdctfltr' ) . ' ' . esc_html__( 'If you leave this field empty default will be used. Type %none% to hide title!', 'prdctfltr' ); ?></span>
												</td>
											</tr>
											<tr valign="top">
												<th scope="row" class="titledesc">
			...
			<?php
				...
				$settings = array(
					...
					'prdctfltr_perpage_title' => array(
						...
						'type' => 'text',
						'desc' => esc_html__( 'Override filter title.', 'prdctfltr' ) . ' ' . esc_html__( 'If you leave this field empty default will be used. Type %none% to hide title!', 'prdctfltr' ),
